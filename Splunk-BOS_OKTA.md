...
### Question 5:
What is the last app that Luciana makes use of SSO to get access into?
...
### Question 6:
What is the most popular form of MFA authentication used either as primary or secondary factor?
Answer guidance: Use the full string found in the data.



### Question 7:
What is the average amount of authenticators used by each user?
Go to OKTA Identity Dashboard.
 #### 4 


### Question 8:
Max Quim works mostly out of Salt Lake City, Utah but his mobile phone number is attributed to what US state?

SPL= index=* user="max@coffeecase.biz" SMS
Scroll down until you see where max did a SMS authentication, Look at target[].alernatedid = 
Use the phone number and google search the area code.
 #### Colorado
